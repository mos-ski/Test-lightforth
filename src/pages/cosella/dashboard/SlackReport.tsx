    ...
    <div className="mx-auto max-w-3xl px-10 py-12">
      ...
      <div className="mt-8 lf-panel p-5">
        ...
        <div className="mt-4 flex gap-3">
          <button onClick={handleSave} className="h-9 rounded-lg bg-rose-600 px-4 text-sm font-semibold text-white hover:bg-rose-700">Save changes</button>
      ...
      <div className="mt-3 rounded-xl border border-slate-200 bg-[#1a1d21] p-5 text-white">
        <p className="flex items-center gap-2 font-bold"><MessageSquare className="h-4 w-4 text-rose-400" /> Cosella Bot <span className="text-xs font-normal text-white/40">Today at {sendTime}</span></p>
