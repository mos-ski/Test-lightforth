            ...
            <div key={integration.id} className="lf-panel flex items-start gap-4 p-5">
              ...
              <div className="min-w-0 flex-1">
                ...
                <button
                  ...
                  className={connected ? 'mt-3 rounded-lg border border-border px-3 py-1.5 text-xs font-semibold text-slate-600 hover:bg-muted' : 'mt-3 rounded-lg bg-rose-600 px-3 py-1.5 text-xs font-semibold text-white hover:bg-rose-700'}
                >
