...
const RISK_BORDER: Record<LiveCallRiskEntry['riskLevel'], string> = {
  green: 'border-green-200', yellow: 'border-amber-300', red: 'border-red-300',
}
  ...
  return (
    <div className="mx-auto max-w-4xl px-10 py-12">
      <div className="flex items-start justify-between gap-4">
        ...
        <button onClick={handleSimulate} className="h-10 flex-shrink-0 rounded-lg bg-rose-600 px-4 text-sm font-semibold text-white hover:bg-rose-700">
          ...
          <div key={entry.id} className={cn('lf-panel border-2 p-5', RISK_BORDER[entry.riskLevel])}>
            ...
            {entry.rescueLog ? (
              ...
              <div className="mt-4 flex gap-2">
                ...
                <button onClick={() => setResolving({ entry, mode: 'whisper' })} className="rounded-lg bg-rose-600 px-3 py-1.5 text-xs font-semibold text-white hover:bg-rose-700">Whisper</button>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 p-4">
          <div className="w-full max-w-sm rounded-2xl bg-white p-6 shadow-xl">
            ...
            <div className="mt-5 flex gap-3">
              <button onClick={() => handleResolve('saved')} className="h-9 flex-1 rounded-lg bg-rose-600 text-sm font-semibold text-white hover:bg-rose-700">Mark saved</button>
