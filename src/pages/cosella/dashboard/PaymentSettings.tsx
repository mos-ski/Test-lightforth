  ...
  return (
    <div className="mx-auto max-w-4xl px-10 py-12">
      ...
      <div className="mt-8 lf-panel p-5">
        ...
        <button disabled={!canAdd} onClick={handleAdd} className="mt-4 h-9 rounded-lg bg-rose-600 px-4 text-sm font-semibold text-white disabled:opacity-40">
          Add deal type
        </button>
      </div>
            ...
            <div key={p.id} className="lf-panel p-5">
              ...
              <button
                ...
                className={connected
                  ...
                  : 'mt-3 rounded-lg bg-rose-600 px-3 py-1.5 text-xs font-semibold text-white hover:bg-rose-700'}
              >
