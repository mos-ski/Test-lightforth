...
const TAG_BADGE: Record<LedgerEntry['tag'], string> = {
  ...
  saved: 'bg-rose-50 text-rose-600',
}
  ...
  return (
    <div className="mx-auto max-w-4xl px-10 py-12">
      <div className="flex items-start justify-between gap-4">
        ...
        <button onClick={handleGenerateRenewalDeck} className="flex h-10 flex-shrink-0 items-center gap-2 rounded-lg bg-rose-600 px-4 text-sm font-semibold text-white hover:bg-rose-700">
