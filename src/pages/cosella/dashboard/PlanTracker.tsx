...
import { logAuditEvent, recordInstallmentOutcome, type PaymentPlan } from '../cosellaOrgStore'
      ...
      <div className="mx-auto max-w-3xl px-10 py-12">
        ...
        <div className="mt-6 lf-panel p-5">
          ...
          <button
            ...
            className="mt-4 h-9 rounded-lg bg-rose-600 px-4 text-sm font-semibold text-white hover:bg-rose-700"
          >
            Send reminder now
          </button>
