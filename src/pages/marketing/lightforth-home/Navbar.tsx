    ...
    <nav className="fixed top-0 left-0 z-50 w-full border-b border-slate-100 bg-white/80 backdrop-blur-lg">
      <div className="mx-auto flex h-16 max-w-6xl items-center justify-between px-6">
        ...
        <div className="hidden items-center gap-3 md:flex">
          <a href="/auth" className="rounded-full border border-slate-200 px-5 py-2 text-sm font-semibold text-slate-700 transition hover:bg-slate-50">
            Login
          </a>
          <button
          ...
          >
            <div className="space-y-1 px-6 py-4">
              ...
              <div className="flex gap-3 pt-2">
                <a href="/auth" className="rounded-full border border-slate-200 px-5 py-2 text-sm font-semibold text-slate-700">
                  Login
                </a>
