...
function mockDownload(os: string) {
  toast.success(`Downloading Lightforth Copilot for ${os}...`, {
    description: 'This is a prototype — no file is actually downloading.',
  })
}

export default function DownloadCopilotPage() {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-slate-50 px-6 py-16">
      <div className="w-full max-w-md text-center">
        <LightforthLogo className="mx-auto" to="/copilot" />
        ...
        <div className="mt-8 rounded-2xl border border-slate-200 bg-white p-8 shadow-sm">
          ...
          <p className="mt-1 text-sm text-slate-500">Download Lightforth Copilot to your computer to get started.</p>
          ...
          <div className="mt-7 border-t border-slate-100 pt-7">
            ...
            <Button
              ...
              onClick={() => navigate(`/desktop-copilot-preview${email ? `?email=${encodeURIComponent(email)}` : ''}`)}
            >
              Open Copilot
            </Button>
          </div>
