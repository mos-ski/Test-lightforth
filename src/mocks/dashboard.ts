...
export const dashboardNavItems: readonly DashboardNavItem[] = [
  ...
  { label: 'My Documents', href: '/v3/documents', iconSrc: '/v3-assets/dashboard-documents.svg', hasChildren: true },
  { label: 'Auto-Apply', href: '/v3/auto-apply', iconSrc: '/v3-assets/dashboard-briefcase.svg' },
  { label: 'Interview Prep', href: '/v3/interview-prep' },
  { label: 'Interview Co-Pilot', href: '/v3/interview-copilot' },
