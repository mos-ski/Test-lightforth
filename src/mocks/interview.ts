...
export const interviewerVoices: readonly InterviewerVoice[] = [
  {
    ...
    name: 'Amelie Laurent',
    title: 'Founder & CEO',
    summary: 'Former co-founder of Opendoor with a direct, founder-style interview rhythm.',
  ...
  },
  {
    ...
    summary: 'Led teams at Figma, Pitch, and Protocol Labs. Precise follow-ups and systems thinking.',
  ...
  },
  {
    ...
    summary: 'Former PM for Linear who presses on prioritization, tradeoffs, and product judgment.',
  ...
  },
  {
    ...
    summary: 'Backend specialist with a bias for architecture, constraints, and technical clarity.',
  ...
  },
  {
    ...
    summary: 'Design partner focused on product taste, user journeys, and narrative quality.',
  ...
  },
  {
    ...
    name: 'Zaid Schwartz',
    title: 'UX Researcher',
    summary: 'Research-heavy interviewer who probes evidence, bias, and customer understanding.',
...
export const interviewLiveSession: InterviewLiveSession = {
  ...
  interviewer: {
    ...
    imageSrc: '/v3-assets/interview-live-nikolas.png',
  },
  candidate: {
    name: 'You',
    title: 'Product Manager',
    label: 'Darnell Smith · You',
    imageSrc: '/v3-assets/interview-live-you.png',
  },
  chatMessages: [
    {
      id: 'chat-1',
