...
- Celebrate wins (new paid conversions, bundle closes)
- Note what objections came up most, flag any that felt under-prepared for
...
### Weekly
- Update pricing/discount info if anything changed
- Add any new objection that came up and wasn't covered

### Monthly
- Review all knowledge base content for accuracy
- Add new case studies as they come in
- Refresh competitor battlecards if a competitor changed pricing or features
...
- Weekly: re-read the objection handling guide, especially the "isn't this cheating" response — it's the one that decides most calls
- Monthly: sit in on another rep's demo call for a fresh perspective
